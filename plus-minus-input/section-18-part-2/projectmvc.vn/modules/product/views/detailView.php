                    ...
                    <div class="detail fl-right">
                        ...
                        <div class="num-order-wp">
                            ...
                            <!-- <div id="buy-amount">
                                ...
                                <input type="text" data-id="<?php echo $product_item['id'] ?>" name="amount" id="amount" value="1" />
                            ...
                            <form action="?mod=cart&action=add&id=<?php echo $product_item['id'] ?>" method="post">
                                <input type="number" data-id="<?php echo $product_item['id'] ?>" name="num-order" class="num-order-<?php echo $product_item['id'] ?>" id="num-order" value="1" min=1 max=30>
                                <input type="submit" class="add-to-cart" value="Thêm giỏ hàng">
                            </form>

                            <!-- <a href="?mod=cart&action=add&id=<?php echo $product_item['id'] ?>" data-id="<?php echo $product_item['id'] ?>" title="" class="add-to-cart">Thêm giỏ hàng</a> -->
                        </div>
