...
<body>
    ...
    ?>
        ...
        <input type="number" min=0 max=20 name="num_order" id="num_order" value="<?php echo $_SESSION['cart']['info']['num_order'] ?>">
        <hr>
        <p>Tổng: <span id="total"><?php echo $_SESSION['cart']['info']['total'] ?></span></p>
    <?php
    } else {
    ?>
        <p>Giá: <span id="price">35</span></p>
