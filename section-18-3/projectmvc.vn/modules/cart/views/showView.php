                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" data-id='<?php echo $product_buy['id'] ?>' min=1 max=50 name="num-order" value="<?php echo $product_buy['qty'] ?>" class="num-order num_order_in_cart num_order_<?php echo $product_buy['id'] ?>">
                                    </td>
