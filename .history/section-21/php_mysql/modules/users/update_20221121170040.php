...
<div id="content">
    ...
    <form class="update" action="" method="post">
        ...
        <select name="gender" id="gender">
            ...
            <option value="male" <?php if (!empty($item['gender']) && $item['gender'] == 'male') echo 'selected' ?>>Nam</option>
            <option value="female" <?php if (!empty($item['gender']) && $item['gender'] == 'female') echo 'selected' ?>>Nữ</option>
        </select>
