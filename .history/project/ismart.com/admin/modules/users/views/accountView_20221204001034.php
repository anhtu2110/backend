            ...
            <div id="update_account">
                <form method="post" action="">
                    ...
                    ?>
                        ...
                        <input type="radio" class="d-inline-block" name="gender" id="male" value="Nam" <?php if ($user['gender'] == 'nam') echo 'checked' ?>>
                        <label for="male" class="d-inline-block mr-2">Nam</label>
                        <input type="radio" class="d-inline-block" name="gender" id="female" value="Nữ" <?php if ($user['gender'] == 'nữ') echo 'checked' ?>>
