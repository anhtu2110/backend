        ...
        <div class="card-body">
            <div id="update_account">
                <form method="post" action="">
                    ...
                    <input type="text" class="d-block" name="username" id="username" disabled>
                    <label for="email" class="d-block">Email</label>
                    <input type="email" class="d-block" name="email" id="email">
                    <label for="number_phone" class="d-block">Số điện thoại</label>
                    <input type="tel" class="d-block" name="number_phone" id="number_phone">
                    <label for="gender" class="d-block">Giới tính</label>
                    <input type="radio" class="d-block" name="gender" id="male" value="Nam">
                    <label for="male" class="d-block">Nam</label>
                    <input type="radio" class="d-block" name="gender" id="female" value="Nữ">
