    ...
    <div class="card">
        ...
        <div class="form-group">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status" id="pending" value="pending" checked <?php if ($page_item['status'] == 'pending') echo 'checked' ?>>
                <label class="form-check-label" for="pending">
                    Chờ duyệt
                </label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" name="status" id="public" value="public" <?php if ($page_item['status'] == 'public') echo 'checked' ?>>
