        ...
        <div class="card-body">
            <form method="POST">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="page_title" id="page_title" value="<?php echo set_value('page_title') ?>">
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="radio" name="status" id="public" value="public" <?php if (isset($status) && $status == 'public') echo 'selected' ?>>
