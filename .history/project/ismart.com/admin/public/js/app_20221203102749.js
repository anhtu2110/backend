$(document).ready(function() {
    ...
    $("button.dropdown").click(function(){
        $("button.dropdown").not(this).next().removeClass('d-block');
        $(this).next().toggleClass('d-block');
    });
    $("button.dropdown-toggle").click(function(){
        $("button.dropdown-toggle").not(this).next().removeClass('d-block');
        $(this).next().toggleClass('d-block');
    });
    $("*").not("button.dropdown").not("button.dropdown-toggle").click(function(){
