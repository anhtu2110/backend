<div id="page-body" class="d-flex">
    <div id="sidebar" class="bg-white">
        <ul id="sidebar-menu">
            ...
            <li class="nav-link">
                <a href="?mod=product&action=list_post">
                    <div class="nav-link-icon d-inline-flex">
                        <i class="far fa-folder"></i>
                    </div>
                    Sản phẩm
                ...
                <ul class="sub-menu">
                    <li><a href="?mod=product&action=add_post">Thêm mới</a></li>
                    <li><a href="?mod=product&action=list_post">Danh sách</a></li>
                    <li><a href="?mod=product&action=cat_post">Danh mục</a></li>
                </ul>
            </li>
            <li class="nav-link">
