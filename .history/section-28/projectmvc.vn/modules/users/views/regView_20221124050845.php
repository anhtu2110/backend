...
if (isset($_POST['btn_reg'])) {
    ...
    if (empty($error)) {
        ...
        echo db_query("SELECT * FROM `tbl_users` WHERE `username` = $username OR `email` = $email");
        // if (db_query("SELECT * FROM `tbl_users` WHERE `username` = $username OR `email` = $email")) {
        //     echo "Username or Email không hợp lệ";
        // }
    }
}
?>
