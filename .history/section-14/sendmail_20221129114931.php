...
try {
    ...
    $mail->Username   = 'daotu2110@gmail.com';                     //SMTP username
    $mail->Password   = '21102003Anhtu';                               //SMTP password
    ...
    $mail->setFrom('daotu2110@gmail.com', 'Đào Anh Tú');
    //addAddress là địa chỉ người nhận
    $mail->addAddress('joe@example.net', 'Joe User');     //Add a recipient
    $mail->addAddress('ellen@example.com');               //Name is optional
    $mail->addAddress('sendmail2110@gmail.com');
    // addReplyto là sau khi nhận họ có thể trả lời tới mail nào       
    $mail->addReplyTo('daotu2110@gmail.com', 'Đào Anh Tú');
