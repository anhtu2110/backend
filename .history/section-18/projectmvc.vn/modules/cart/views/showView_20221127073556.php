                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <input type="number" min=1 max=50 name="num-order" value="<?php echo $product_buy['qty'] ?>" class="num-order">
                                    </td>
                                    <td><?php echo currency_format($product_buy['sub_total']) ?></td>
                                    <td>
                                        <a href="" title="" class="<?php echo $product_buy['url_del'] ?>"><i class="fa fa-trash-o"></i></a>
                                    </td>
                                </tr>
                            <?php
                            }
