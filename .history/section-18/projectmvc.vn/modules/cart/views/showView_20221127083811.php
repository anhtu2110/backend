                    ...
                    <table class="table">
                            ...
                            <form action="?mod=cart&action=update_cart" method="post">
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="number" min=1 max=50 name="qty[<?php echo $product_buy['id'] ?>]" value="<?php echo $product_buy['qty'] ?>" class="num-order">
                                        </td>
                                        <td><?php echo currency_format($product_buy['sub_total']) ?></td>
                                        <td>
                        ...
                        <tfoot>
                            <tr>
                                <td colspan="7">
                                    <div class="clearfix">
                                        <p id="total-price" class="fl-right">Tổng giá: <span><?php echo currency_format($total_cart['total']) ?></span></p>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="7">
                                    <div class="clearfix">
                                        <div class="fl-right">
                                            <input type="submit" name="btn_update_cart" value="Cập nhật giỏ hàng" id="update-cart">
                                            <a href="?mod=cart&action=update_cart" title="" id="update-cart">Cập nhật giỏ hàng</a>
