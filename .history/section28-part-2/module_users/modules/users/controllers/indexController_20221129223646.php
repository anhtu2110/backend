<p>Chào bạn <?php echo $fullname ?></p>
<p>Bạn vui lòng click vào đường link này để kích hoạt tài khoản: LINK</p>
    ...
    if (isset($_POST['btn_reg'])) {
        ...
        if (empty($error)) {
            if (user_exist($username, $email)) {
                ...
                $content = "<a target='blank' href='http://localhost/backend/section28-part-2/module_users/?mod=users&action=reg'>Nhấn vào đây để kích hoạt tài khoản<a/>";
