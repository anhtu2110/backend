...
function regAction()
{
    ...
    echo send_mail('daotu2110@gmail.com', 'Đào Anh Tú', 'Kích hoạt tài khoản', "<a target='blank' href='http://localhost/backend/section28-part-2/module_users/?mod=users&action=login'>Nhấn vào đây để kích hoạt tài khoản<a/>");
    if (isset($_POST['btn_reg'])) {
        ...
        if (empty($error)) {
            if (user_exist($username, $email)) {
                ...
                add_user($fullname, $username, $password, $email);
