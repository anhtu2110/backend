...
function regAction()
{
    ...
    echo send_mail('daotu2110@gmail.com', 'Đào Anh Tú', 'Kích hoạt tài khoản', "<a href='http://localhost/backend/section28-part-2/module_users/?mod=users&action=login'><a/>");
